...
public class CategoryController extends BaseController {
    ...
    public String category(Request request) {
        ...
        Set<String> category = mapping.keySet();
    ...
    public String categoryPage(Request request, @PathParam String keyword, @PathParam int page, @Param(defaultValue = "12") int limit) {
