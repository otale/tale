 ...
 */
public final class TaleSqliteJdbc {

    private static final Properties jdbc_prop = new Properties();

    public static JdbcConf jdbcConf;

    private TaleSqliteJdbc() {
    }

    static {
        jdbc_prop.put("driverClassName", TaleConst.SQLITE_DRIVER_NAME);
    ...
    public static void testConn() {
        if (jdbc_prop.containsKey("url") && jdbc_prop.containsKey("username") && jdbc_prop.containsKey("password")) {
            try {
                ...
                String cp = TaleSqliteJdbc.class.getClassLoader().getResource("").getPath();
