...
public class TaleConst {
    ...
    public static final String CLASSPATH =
        new File(AdminApiController.class.getResource("/").getPath()).getPath() + File.separatorChar;
    ...
    public static final String MUSIC_IFRAME =
    ...
    public static final String GIST_REG_PATTERN =
        "&lt;script src=\"https://gist.github.com/(\\w+)/(\\w+)\\.js\">&lt;/script>";
    public static final String GIST_REPLATE_PATTERN = "<script src=\"https://gist.github.com/$1/$2\\.js\"></script>";

    public static final String SQL_QUERY_METAS =
    ...
    public static final String SQL_QUERY_ARTICLES =
