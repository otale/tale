    ...
    methods: {
        load: function () {
            ...
            axios.all([
                ...
                axios.get('/admin/api/articles/' + cid + '')
            ]).then(axios.spread(function (categoryResp, articleResp) {
                $vm.categories = categoryResp.data.payload;
                $vm.article = articleResp.data.payload;
            }));
        },
        autoSave: function () {
            var $vm = this;
