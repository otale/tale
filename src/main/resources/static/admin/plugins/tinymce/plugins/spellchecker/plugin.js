...
var spellchecker = (function () {
  ...
  var $_eor9tkiojc7tmc9o = { hasProPlugin: hasProPlugin };
  ...
  var DomTextMatcher = function (node, editor) {
    ...
    function genReplacer(callback) {
      ...
      return function (range) {
        var before, after, parentNode, startNode = range.startNode, endNode = range.endNode, matchIndex = range.matchIndex, doc = dom.doc;
        if (startNode === endNode) {
          var node = startNode;
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_ch5qaeiqjc7tmc9r.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_ch5qaeiqjc7tmc9r.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_ch5qaeiqjc7tmc9r.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_41c8qsivjc7tmca3.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_ch5qaeiqjc7tmc9r.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_41c8qsivjc7tmca3.fireSpellcheckStart(editor);
  };
  var $_etfn1firjc7tmc9w = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_ch5qaeiqjc7tmc9r.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_ch5qaeiqjc7tmc9r.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_etfn1firjc7tmc9w.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_3w9jsuipjc7tmc9q = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_etfn1firjc7tmc9w.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_2mgx2zixjc7tmcae = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_ch5qaeiqjc7tmc9r.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_ch5qaeiqjc7tmc9r.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_25wyh5iyjc7tmcag = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_etfn1firjc7tmc9w.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_etfn1firjc7tmc9w.addToDictionary(editor, pluginUrl, startedState, textMatcherState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_etfn1firjc7tmc9w.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_etfn1firjc7tmc9w.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_etfn1firjc7tmc9w.findSpansByIndex(editor, $_etfn1firjc7tmc9w.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_9fcp5hizjc7tmcaj = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_eor9tkiojc7tmc9o.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_ch5qaeiqjc7tmc9r.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_25wyh5iyjc7tmcag.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_9fcp5hizjc7tmcaj.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState);
      $_2mgx2zixjc7tmcae.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_3w9jsuipjc7tmc9q.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  var Plugin = function () {
  };
