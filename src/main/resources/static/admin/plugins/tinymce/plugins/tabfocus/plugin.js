...
var tabfocus = (function () {
  ...
  var $_25zigsjbjc7tmccq = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_25zigsjbjc7tmccq.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_484velj4jc7tmcck = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_484velj4jc7tmcck.setup(editor);
  });
  var Plugin = function () {
  };
