...
var wordcount = (function () {
  ...
  var $_6libokrqjc7tmesd = {
    each: each,
    map: map
  };

  var SETS$1 = $_7wfz3srojc7tmerj.SETS;
  var OTHER = $_7wfz3srojc7tmerj.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_6libokrqjc7tmesd.map(string.split(''), memoized);
  };
  var $_xqlfjrpjc7tmes6 = { classify: classify };

  var ci = $_7wfz3srojc7tmerj.characterIndices;
  ...
  var $_53r7whrrjc7tmesj = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING = $_7wfz3srojc7tmerj.EMPTY_STRING;
  var WHITESPACE = $_7wfz3srojc7tmerj.WHITESPACE;
  var PUNCTUATION = $_7wfz3srojc7tmerj.PUNCTUATION;
  ...
  var doGetWords = function (string, options) {
    var i = 0;
    var map = $_xqlfjrpjc7tmes6.classify(string);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = string.charAt(i);
      word.push(chr);
      if ($_53r7whrrjc7tmesj.isWordBoundary(map, i)) {
        word = word.join(EMPTY_STRING);
        if (word && (includeWhitespace || !WHITESPACE.test(word)) && (includePunctuation || !PUNCTUATION.test(word))) {
          if (isProtocol(word)) {
  ...
  var $_8j5cs2rnjc7tmerd = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_8j5cs2rnjc7tmerd.getWords(getTextContent(editor)).length;
  };
  var $_46illarmjc7tmer6 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_46illarmjc7tmer6.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_3sisjgrljc7tmer3 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_46illarmjc7tmer6.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_z289drsjc7tmesp = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_z289drsjc7tmesp.setup(editor);
    return $_3sisjgrljc7tmer3.get(editor);
  });
  var Plugin = function () {
  };
