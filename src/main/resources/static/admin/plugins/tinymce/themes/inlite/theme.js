...
var inlite = (function () {
  ...
  var $_9s8s4t167jc7tmkf0 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_1gf2vo16bjc7tmkfa.fromClientRect(clientRect)) : null;
  };
  var $_g8x25b16ajc7tmkf7 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_fjwxz1169jc7tmkf5.result(predicateIds[i].id, $_g8x25b16ajc7tmkf7.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_fjwxz1169jc7tmkf5.result(predicateIds[x].id, $_g8x25b16ajc7tmkf7.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_fjwxz1169jc7tmkf5.result(id, $_g8x25b16ajc7tmkf7.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_7sjew016kjc7tmkft.isArray(value)) {
      return value;
    } else if ($_7sjew016kjc7tmkft.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_7sjew016kjc7tmkft.isBoolean(value)) {
  ...
  var $_eutc6j16jjc7tmkfp = {
    getStringOr: getByTypeOr($_7sjew016kjc7tmkft.isString),
    getBoolOr: getByTypeOr($_7sjew016kjc7tmkft.isBoolean),
    getNumberOr: getByTypeOr($_7sjew016kjc7tmkft.isNumber),
    getHandlerOr: getByTypeOr($_7sjew016kjc7tmkft.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_7sjew016kjc7tmkft.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_1gf2vo16bjc7tmkfa.toClientRect(targetRect),
        contentAreaRect: $_1gf2vo16bjc7tmkfa.toClientRect(contentAreaRect),
        panelRect: $_1gf2vo16bjc7tmkfa.toClientRect(panelRect)
      });
      return $_1gf2vo16bjc7tmkfa.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_eutc6j16jjc7tmkfp.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_eutc6j16jjc7tmkfp.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_eutc6j16jjc7tmkfp.getHandlerOr(editor, 'inline_toolbar_position_handler', $_c9c8tp16ljc7tmkfy.defaultHandler);
  };
  ...
  var fireSkinLoaded = function (editor, callback) {
    var done = function () {
      ...
      $_54prg016gjc7tmkfl.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_cikn0i16hjc7tmkfn.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded(editor, callback);
    };
    if ($_cikn0i16hjc7tmkfn.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_16c9dn16fjc7tmkfi = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_9s8s4t167jc7tmkf0.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_7x4imq16cjc7tmkfc.fromContextToolbars(toolbars);
    result = $_fjwxz1169jc7tmkf5.match(editor, [
      $_b99q6g168jc7tmkf2.element(elements[0], contextToolbarsPredicateIds),
      $_fezhkf16ejc7tmkff.textSelection('text'),
      $_fezhkf16ejc7tmkff.emptyTextBlock(elements, 'insert'),
      $_b99q6g168jc7tmkf2.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = result = $_fjwxz1169jc7tmkf5.match(editor, [$_fezhkf16ejc7tmkff.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_16c9dn16fjc7tmkfi.load(editor, function () {
  ...
  var $_bf734y163jc7tmkeu = { renderUI: renderUI };
  ...
  var never = $_aiv4pk16qjc7tmkh5.never;
  var always = $_aiv4pk16qjc7tmkh5.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_aiv4pk16qjc7tmkh5.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var indexOf = function (xs, x) {
    ...
    return r === -1 ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.some(r);
  };
  ...
  var find = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_q2gu716pjc7tmkh1.some(x);
      }
    }
    return $_q2gu716pjc7tmkh1.none();
  };
  var findIndex = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_q2gu716pjc7tmkh1.some(i);
      }
    }
    return $_q2gu716pjc7tmkh1.none();
  };
  ...
  var head = function (xs) {
    return xs.length === 0 ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.some(xs[0]);
  };
  var last = function (xs) {
    return xs.length === 0 ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.some(xs[xs.length - 1]);
  };
  var $_44ukot16ojc7tmkgr = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_5c0ohw16xjc7tmkio.parseBox(settings.border);
      self.paddingBox = $_5c0ohw16xjc7tmkio.parseBox(settings.padding);
      self.marginBox = $_5c0ohw16xjc7tmkio.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_5c0ohw16xjc7tmkio.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_5c0ohw16xjc7tmkio.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_5c0ohw16xjc7tmkio.measureBox(elm, 'margin');
    ...
    parents: function (selector) {
      var self = this, ctrl, parents = new Collection$1();
    ...
    reflow: function () {
      $_444kth174jc7tmkk7.remove(this);
  ...
  var NotificationManagerImpl = function (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_44ukot16ojc7tmkgr.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_44ukot16ojc7tmkgr.each(notifications, function (notification, index) {
          if (index > 0) {
      ...
      self.on('postrender show', function (e) {
        if (e.control == self) {
          ...
          if (self.modal && !hasModal) {
            ...
            if (!$modalBlockEl[0]) {
              $modalBlockEl = $('<div id="' + prefix + 'modal-block" class="' + prefix + 'reset ' + prefix + 'fade"></div>').appendTo(self.getContainerElm());
            }
            Delay.setTimeout(function () {
  ...
  function toggleFullScreenState(state) {
    var noScaleMetaValue = 'width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0', viewport = $('meta[name=viewport]')[0], contentValue;
  ...
  function handleWindowResize() {
    ...
    function reposition() {
      var i, rect = funcs.getWindowSize(), layoutRect;
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state != self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_5c0ohw16xjc7tmkio.parseBox(self.settings.border);
          ...
          self.borderBox = $_5c0ohw16xjc7tmkio.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_bf734y163jc7tmkeu.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_a3b7a5162jc7tmker = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_ejyk9s17ojc7tmko1.resolve(name, scope);
  };
  ...
  var $_2tohhc17njc7tmkny = { getOrDie: getOrDie };

  var FileReader = function () {
    var f = $_2tohhc17njc7tmkny.getOrDie('FileReader');
    return new f();
  };
  ...
  var $_duyu2517ljc7tmknq = { blobToBase64: blobToBase64 };
  ...
  var $_c32fb217rjc7tmko5 = { pickFile: pickFile };
  ...
  var $_bb539w17tjc7tmkoe = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_d2f8us17vjc7tmkol.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_d2f8us17vjc7tmkol.resolve(dom, bookmark));
  };
  ...
  var $_cad62617ujc7tmkog = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_bb539w17tjc7tmkoe.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_cad62617ujc7tmkog.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_bh7jxd17sjc7tmko9.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_c32fb217rjc7tmko5.pickFile().then(function (files) {
          var blob = files[0];
          $_duyu2517ljc7tmknq.blobToBase64(blob).then(function (base64) {
            $_bh7jxd17sjc7tmko9.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_bh7jxd17sjc7tmko9.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_14lvpb17kjc7tmknm = { addToEditor: addToEditor };
  ...
  var $_2k7pwb17zjc7tmkoz = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_2ub9yz181jc7tmkpq.isAbsolute(href) && $_2ub9yz181jc7tmkpq.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_bh7jxd17sjc7tmko9.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_bh7jxd17sjc7tmko9.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_90dsob180jc7tmkp3 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_7sjew016kjc7tmkft.isArray(items)) {
      return items;
    } else if ($_7sjew016kjc7tmkft.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_cxffoe182jc7tmkpt = { create: create$2 };

  var Panel$1 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_cxffoe182jc7tmkpt.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_cxffoe182jc7tmkpt.create(editor, 'text', $_cikn0i16hjc7tmkfn.getTextSelectionToolbarItems(editor)),
        $_cxffoe182jc7tmkpt.create(editor, 'insert', $_cikn0i16hjc7tmkfn.getInsertToolbarItems(editor)),
        $_90dsob180jc7tmkp3.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_cikn0i16hjc7tmkfn.getPositionHandler(editor);
      contentAreaRect = $_g8x25b16ajc7tmkf7.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_c9c8tp16ljc7tmkfy.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_c9c8tp16ljc7tmkfy.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_2k7pwb17zjc7tmkoz.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_c9c8tp16ljc7tmkfy.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_g8x25b16ajc7tmkf7.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_c9c8tp16ljc7tmkfy.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_c9c8tp16ljc7tmkfy.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_54prg016gjc7tmkfl.fireBeforeRenderUI(editor);
  ...
  var Button = Widget.extend({
    ...
    repaint: function () {
      var btnElm = this.getEl().firstChild, btnStyle;
      if (btnElm) {
  ...
  var ColorButton = PanelButton.extend({
    ...
    renderHtml: function () {
      ...
      var image = self.settings.image ? ' style="background-image: url(\'' + self.settings.image + '\')"' : '', textHtml = '';
      if (text) {
        self.classes.add('btn-has-text');
        textHtml = '<span class="' + prefix + 'txt">' + self.encode(text) + '</span>';
      }
  ...
  var $_cuwcjf18pjc7tmktm = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_aiv4pk16qjc7tmkh5.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return $_q2gu716pjc7tmkh1.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_cs0h3018qjc7tmktq = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_7dt9nj18ujc7tmku4 = { cached: cached };

  var $_b1oint18wjc7tmku7 = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_b1oint18wjc7tmku7.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_b1oint18wjc7tmku7.ELEMENT);
  var isText = isType$1($_b1oint18wjc7tmku7.TEXT);
  var isDocument = isType$1($_b1oint18wjc7tmku7.DOCUMENT);
  var $_exz59k18vjc7tmku5 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_exz59k18vjc7tmku5.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_7dt9nj18ujc7tmku4.cached(function () {
    return getBody($_cs0h3018qjc7tmktq.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_cs0h3018qjc7tmktq.fromDom(body);
  };
  var $_g9sjtk18tjc7tmku1 = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  var Immutable = function () {
    ...
    return function () {
      ...
      var struct = {};
      $_44ukot16ojc7tmkgr.each(fields, function (name, i) {
        struct[name] = $_aiv4pk16qjc7tmkh5.constant(values[i]);
      });
      return struct;
    };
  };
  ...
  var validateStrArr = function (label, array) {
    if (!$_3dq2ct18yjc7tmkur.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_44ukot16ojc7tmkgr.each(array, function (a) {
      if (!$_3dq2ct18yjc7tmkur.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_44ukot16ojc7tmkgr.find(sorted, function (s, i) {
  ...
  var MixedBag = function (required, optional) {
    ...
    $_8ma29u193jc7tmkv4.validateStrArr('required', required);
    $_8ma29u193jc7tmkv4.validateStrArr('optional', optional);
    $_8ma29u193jc7tmkv4.checkDupes(everything);
    return function (obj) {
      var keys = $_fvbi3e192jc7tmkv0.keys(obj);
      var allReqd = $_44ukot16ojc7tmkgr.forall(required, function (req) {
        return $_44ukot16ojc7tmkgr.contains(keys, req);
      });
      if (!allReqd)
        $_8ma29u193jc7tmkv4.reqMessage(required, keys);
      var unsupported = $_44ukot16ojc7tmkgr.filter(keys, function (key) {
        return !$_44ukot16ojc7tmkgr.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_8ma29u193jc7tmkv4.unsuppMessage(unsupported);
      var r = {};
      $_44ukot16ojc7tmkgr.each(required, function (req) {
        r[req] = $_aiv4pk16qjc7tmkh5.constant(obj[req]);
      });
      $_44ukot16ojc7tmkgr.each(optional, function (opt) {
        r[opt] = $_aiv4pk16qjc7tmkh5.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? $_q2gu716pjc7tmkh1.some(obj[opt]) : $_q2gu716pjc7tmkh1.none());
      });
      return r;
    };
  };

  var $_2rxutu18zjc7tmkut = {
    immutable: Immutable,
  ...
  var $_89ufmu194jc7tmkv7 = { toArray: toArray };

  var node = function () {
    var f = $_2tohhc17njc7tmkny.getOrDie('Node');
    return f;
  };
  ...
  var unknown = function () {
    return nu({
      current: undefined,
      version: $_b3fn0u19ajc7tmkw4.unknown()
    });
  };
  ...
  var $_12qlhf199jc7tmkw1 = {
    unknown: unknown,
    nu: nu,
    edge: $_aiv4pk16qjc7tmkh5.constant(edge),
    chrome: $_aiv4pk16qjc7tmkh5.constant(chrome),
    ie: $_aiv4pk16qjc7tmkh5.constant(ie),
    opera: $_aiv4pk16qjc7tmkh5.constant(opera),
    firefox: $_aiv4pk16qjc7tmkh5.constant(firefox),
    safari: $_aiv4pk16qjc7tmkh5.constant(safari)
  };
  ...
  var $_2rz0qd19bjc7tmkw6 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_aiv4pk16qjc7tmkh5.constant(windows$1),
    ios: $_aiv4pk16qjc7tmkh5.constant(ios),
    android: $_aiv4pk16qjc7tmkh5.constant(android),
    linux: $_aiv4pk16qjc7tmkh5.constant(linux),
    osx: $_aiv4pk16qjc7tmkh5.constant(osx),
    solaris: $_aiv4pk16qjc7tmkh5.constant(solaris),
    freebsd: $_aiv4pk16qjc7tmkh5.constant(freebsd)
  };
  ...
  var DeviceType = function (os, browser, userAgent) {
    ...
    return {
      isiPad: $_aiv4pk16qjc7tmkh5.constant(isiPad),
      isiPhone: $_aiv4pk16qjc7tmkh5.constant(isiPhone),
      isTablet: $_aiv4pk16qjc7tmkh5.constant(isTablet),
      isPhone: $_aiv4pk16qjc7tmkh5.constant(isPhone),
      isTouch: $_aiv4pk16qjc7tmkh5.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_aiv4pk16qjc7tmkh5.constant(iOSwebview)
    };
  };

  var detect$3 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_44ukot16ojc7tmkgr.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$3(browsers, userAgent).map(function (browser) {
      var version = $_b3fn0u19ajc7tmkw4.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$3(oses, userAgent).map(function (os) {
      var version = $_b3fn0u19ajc7tmkw4.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var head$1 = function (str) {
    return str === '' ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.some(str.substr(0, 1));
  };
  var tail = function (str) {
    return str === '' ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.some(str.substring(1));
  };
  var $_75s1wr19hjc7tmkwr = {
    first: first,
    last: last$1,
    head: head$1,
    tail: tail
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_1u20ec19gjc7tmkwp.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_1u20ec19gjc7tmkwp.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_1u20ec19gjc7tmkwp.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_1u20ec19gjc7tmkwp.addToEnd(str, prefix);
  };
  var contains$2 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_75s1wr19hjc7tmkwr.head(str).bind(function (head) {
      return $_75s1wr19hjc7tmkwr.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_5jix8b19fjc7tmkwn.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_5jix8b19fjc7tmkwn.contains(uastring, 'edge/') && $_5jix8b19fjc7tmkwn.contains(uastring, 'chrome') && $_5jix8b19fjc7tmkwn.contains(uastring, 'safari') && $_5jix8b19fjc7tmkwn.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_5jix8b19fjc7tmkwn.contains(uastring, 'chrome') && !$_5jix8b19fjc7tmkwn.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_5jix8b19fjc7tmkwn.contains(uastring, 'msie') || $_5jix8b19fjc7tmkwn.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_5jix8b19fjc7tmkwn.contains(uastring, 'safari') || $_5jix8b19fjc7tmkwn.contains(uastring, 'mobile/')) && $_5jix8b19fjc7tmkwn.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_5jix8b19fjc7tmkwn.contains(uastring, 'iphone') || $_5jix8b19fjc7tmkwn.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_c8wki919ejc7tmkwh = {
    browsers: $_aiv4pk16qjc7tmkh5.constant(browsers),
    oses: $_aiv4pk16qjc7tmkh5.constant(oses)
  };

  var detect$1 = function (userAgent) {
    var browsers = $_c8wki919ejc7tmkwh.browsers();
    var oses = $_c8wki919ejc7tmkwh.oses();
    var browser = $_b4snfm19djc7tmkwd.detectBrowser(browsers, userAgent).fold($_12qlhf199jc7tmkw1.unknown, $_12qlhf199jc7tmkw1.nu);
    var os = $_b4snfm19djc7tmkwd.detectOs(oses, userAgent).fold($_2rz0qd19bjc7tmkw6.unknown, $_2rz0qd19bjc7tmkw6.nu);
  ...
  var $_5q8vat198jc7tmkvz = { detect: detect$1 };

  var detect = $_7dt9nj18ujc7tmku4.cached(function () {
    var userAgent = navigator.userAgent;
    return $_5q8vat198jc7tmkvz.detect(userAgent);
  });
  var $_arfio9197jc7tmkvw = { detect: detect };

  var ELEMENT = $_b1oint18wjc7tmku7.ELEMENT;
  var DOCUMENT = $_b1oint18wjc7tmku7.DOCUMENT;
  ...
  var all$2 = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_44ukot16ojc7tmkgr.map(base.querySelectorAll(selector), $_cs0h3018qjc7tmktq.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? $_q2gu716pjc7tmkh1.none() : $_q2gu716pjc7tmkh1.from(base.querySelector(selector)).map($_cs0h3018qjc7tmktq.fromDom);
  };
  var $_8g2p9819ijc7tmkws = {
    all: all$2,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_44ukot16ojc7tmkgr.exists(elements, $_aiv4pk16qjc7tmkh5.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_5pb9a1196jc7tmkvu.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_arfio9197jc7tmkvw.detect().browser;
  var contains$1 = browser.isIE() ? ieContains : regularContains;
  var $_23cqec195jc7tmkvl = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$1,
    is: $_8g2p9819ijc7tmkws.is
  };

  var owner = function (element) {
    return $_cs0h3018qjc7tmktq.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_cs0h3018qjc7tmktq.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_cs0h3018qjc7tmktq.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return $_q2gu716pjc7tmkh1.from(dom.parentNode).map($_cs0h3018qjc7tmktq.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children$2(p);
      return $_44ukot16ojc7tmkgr.findIndex(kin, function (elem) {
        return $_23cqec195jc7tmkvl.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_3dq2ct18yjc7tmkur.isFunction(isRoot) ? isRoot : $_aiv4pk16qjc7tmkh5.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_cs0h3018qjc7tmktq.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings$2 = function (element) {
    var filterSelf = function (elements) {
      return $_44ukot16ojc7tmkgr.filter(elements, function (x) {
        return !$_23cqec195jc7tmkvl.eq(element, x);
      });
    };
    return parent$1(element).map(children$2).map(filterSelf).getOr([]);
  };
  var offsetParent = function (element) {
    var dom = element.dom();
    return $_q2gu716pjc7tmkh1.from(dom.offsetParent).map($_cs0h3018qjc7tmktq.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return $_q2gu716pjc7tmkh1.from(dom.previousSibling).map($_cs0h3018qjc7tmktq.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return $_q2gu716pjc7tmkh1.from(dom.nextSibling).map($_cs0h3018qjc7tmktq.fromDom);
  };
  var prevSiblings = function (element) {
    return $_44ukot16ojc7tmkgr.reverse($_89ufmu194jc7tmkv7.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_89ufmu194jc7tmkv7.toArray(element, nextSibling);
  };
  var children$2 = function (element) {
    var dom = element.dom();
    return $_44ukot16ojc7tmkgr.map(dom.childNodes, $_cs0h3018qjc7tmktq.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return $_q2gu716pjc7tmkh1.from(children[index]).map($_cs0h3018qjc7tmktq.fromDom);
  };
  ...
  var spot = $_2rxutu18zjc7tmkut.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children$2(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_a3nz0u18xjc7tmkub = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants$1($_g9sjtk18tjc7tmku1.body(), predicate);
  };
  var ancestors$1 = function (scope, predicate, isRoot) {
    return $_44ukot16ojc7tmkgr.filter($_a3nz0u18xjc7tmkub.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_44ukot16ojc7tmkgr.filter($_a3nz0u18xjc7tmkub.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_44ukot16ojc7tmkgr.filter($_a3nz0u18xjc7tmkub.children(scope), predicate);
  };
  var descendants$1 = function (scope, predicate) {
    var result = [];
    $_44ukot16ojc7tmkgr.each($_a3nz0u18xjc7tmkub.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all = function (selector) {
    return $_8g2p9819ijc7tmkws.all(selector);
  };
  var ancestors = function (scope, selector, isRoot) {
    return $_9mvws018sjc7tmktx.ancestors(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    }, isRoot);
  };
  var siblings = function (scope, selector) {
    return $_9mvws018sjc7tmktx.siblings(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    });
  };
  var children = function (scope, selector) {
    return $_9mvws018sjc7tmktx.children(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    });
  };
  var descendants = function (scope, selector) {
    return $_8g2p9819ijc7tmkws.all(selector, scope);
  };
  var $_d1cioc18rjc7tmktw = {
    all: all,
    ancestors: ancestors,
    siblings: siblings,
    children: children,
  ...
  var select = function (selector, root) {
    return $_44ukot16ojc7tmkgr.map($_d1cioc18rjc7tmktw.descendants($_cs0h3018qjc7tmktq.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_cuwcjf18pjc7tmktm.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_aiv4pk16qjc7tmkh5.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_44ukot16ojc7tmkgr.map($_44ukot16ojc7tmkgr.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_44ukot16ojc7tmkgr.map($_44ukot16ojc7tmkgr.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$1 = function (elm) {
    ...
    return $_44ukot16ojc7tmkgr.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_555l8718ojc7tmktb = { find: find$1 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_aiv4pk16qjc7tmkh5.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_44ukot16ojc7tmkgr.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_44ukot16ojc7tmkgr.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_44ukot16ojc7tmkgr.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_44ukot16ojc7tmkgr.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_44ukot16ojc7tmkgr.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_555l8718ojc7tmktb.find(bodyElm);
  ...
  var ClosestOrAncestor = function (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? $_q2gu716pjc7tmkh1.some(scope) : $_3dq2ct18yjc7tmkur.isFunction(isRoot) && isRoot(scope) ? $_q2gu716pjc7tmkh1.none() : ancestor(scope, a, isRoot);
  };

  var first$2 = function (predicate) {
    return descendant$1($_g9sjtk18tjc7tmku1.body(), predicate);
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_cs0h3018qjc7tmktq.fromDom(element);
      if (predicate(el))
        return $_q2gu716pjc7tmkh1.some(el);
      else if (stop(el))
        break;
    }
    return $_q2gu716pjc7tmkh1.none();
  ...
  var sibling$1 = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return $_q2gu716pjc7tmkh1.none();
    return child$2($_cs0h3018qjc7tmktq.fromDom(element.parentNode), function (x) {
      return !$_23cqec195jc7tmkvl.eq(scope, x) && predicate(x);
    });
  };
  var child$2 = function (scope, predicate) {
    var result = $_44ukot16ojc7tmkgr.find(scope.dom().childNodes, $_aiv4pk16qjc7tmkh5.compose(predicate, $_cs0h3018qjc7tmktq.fromDom));
    return result.map($_cs0h3018qjc7tmktq.fromDom);
  };
  var descendant$1 = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_cs0h3018qjc7tmktq.fromDom(element.childNodes[i])))
          return $_q2gu716pjc7tmkh1.some($_cs0h3018qjc7tmktq.fromDom(element.childNodes[i]));
  ...
  var first$1 = function (selector) {
    return $_8g2p9819ijc7tmkws.one(selector);
  };
  var ancestor = function (scope, selector, isRoot) {
    return $_34ciqw19ojc7tmkxh.ancestor(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    }, isRoot);
  };
  var sibling = function (scope, selector) {
    return $_34ciqw19ojc7tmkxh.sibling(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    });
  };
  var child$1 = function (scope, selector) {
    return $_34ciqw19ojc7tmkxh.child(scope, function (e) {
      return $_8g2p9819ijc7tmkws.is(e, selector);
    });
  };
  var descendant = function (scope, selector) {
    return $_8g2p9819ijc7tmkws.one(selector, scope);
  };
  var closest = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_8g2p9819ijc7tmkws.is, ancestor, scope, selector, isRoot);
  };
  var $_8edx4d19njc7tmkxf = {
    first: first$1,
    ancestor: ancestor,
    sibling: sibling,
    child: child$1,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_age68219rjc7tmky7.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_age68219rjc7tmky7.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_age68219rjc7tmky7.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_age68219rjc7tmky7.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_age68219rjc7tmky7.postRenderFormat(editor, name)
      });
    });
  };
  var $_7axgje19qjc7tmky5 = { register: register };

  var getSpecifiedFontProp = function (propName, rootElm, elm) {
    while (elm !== rootElm) {
      if (elm.style[propName]) {
        var foundStyle = elm.style[propName];
        return foundStyle !== '' ? $_q2gu716pjc7tmkh1.some(foundStyle) : $_q2gu716pjc7tmkh1.none();
      }
      elm = elm.parentNode;
    }
    return $_q2gu716pjc7tmkh1.none();
  ...
  var getComputedFontProp = function (propName, elm) {
    return $_q2gu716pjc7tmkh1.from(DOMUtils.DOM.getStyle(elm, propName, true));
  };
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return $_q2gu716pjc7tmkh1.from(elm).map($_cs0h3018qjc7tmktq.fromDom).filter($_exz59k18vjc7tmku5.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_9i7jvh19tjc7tmkye = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_aiv4pk16qjc7tmkh5.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_9i7jvh19tjc7tmkye.getFontFamily(editor.getBody(), e.element);
  ...
  var $_1sz2yb19sjc7tmkya = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_9i7jvh19tjc7tmkye.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_9i7jvh19tjc7tmkye.toPt(px, precision);
  ...
  var $_2nn6sd19ujc7tmkyk = { register: register$2 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_age68219rjc7tmky7.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_age68219rjc7tmky7.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_59kq1e19vjc7tmkyn = { register: register$3 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_age68219rjc7tmky7.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_fticfv19wjc7tmkyr = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_44ukot16ojc7tmkgr.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_44ukot16ojc7tmkgr.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_44ukot16ojc7tmkgr.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_55d1sj19xjc7tmkyw = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_age68219rjc7tmky7.postRenderFormat(editor, name),
        onclick: $_age68219rjc7tmky7.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_age68219rjc7tmky7.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_66gi9j19yjc7tmkz1 = { register: register$6 };
  ...
  var $_d75gmk19zjc7tmkz7 = { register: register$7 };
  ...
  var $_45e6sp1a0jc7tmkz9 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_8edx4d19njc7tmkxf.descendant($_cs0h3018qjc7tmktq.fromDom(document.body), editor.settings.ui_container).fold($_aiv4pk16qjc7tmkh5.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_59kq1e19vjc7tmkyn.register(editor);
    $_7axgje19qjc7tmky5.register(editor);
    $_66gi9j19yjc7tmkz1.register(editor);
    $_d75gmk19zjc7tmkz7.register(editor);
    $_2nn6sd19ujc7tmkyk.register(editor);
    $_1sz2yb19sjc7tmkya.register(editor);
    $_fticfv19wjc7tmkyr.register(editor);
    $_45e6sp1a0jc7tmkz9.register(editor);
    $_55d1sj19xjc7tmkyw.register(editor);
  };
  var $_drz9cz19mjc7tmkx8 = { setup: setup };

  var GridLayout = AbsoluteLayout.extend({
    recalc: function (container) {
      var settings, rows, cols, items, contLayoutRect, width, height, rect, ctrlLayoutRect, ctrl, x, y, posX, posY, ctrlSettings, contPaddingBox, align, spacingH, spacingV, alignH, alignV, maxX, maxY, colWidths = [], rowHeights = [], ctrlMinWidth, ctrlMinHeight, availableWidth, availableHeight, reverseRows, idx;
  ...
  var MenuButton = Button.extend({
    ...
    renderHtml: function () {
      var self = this, id = self._id, prefix = self.classPrefix;
      var icon = self.settings.icon, image, text = self.state.get('text'), textHtml = '';
  ...
  var Throbber = function (elm, inline) {
    var self = this, state, classPrefix = Control$1.classPrefix, timer;
  ...
  var Slider = Widget.extend({
    ...
    postRender: function () {
      var self = this, minValue, maxValue, screenCordName, stylePosName, sizeName, shortSizeName;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_444kth174jc7tmkk7,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_3tr7ri17hjc7tmkn8,
      Panel: Panel,
      Movable: $_1tyl6x175jc7tmkkb,
      Resizable: $_6sd9oo17ijc7tmkne,
      ...
      FormatControls: $_drz9cz19mjc7tmkx8,
  ...
  ThemeManager.add('inlite', function (editor) {
    ...
    $_drz9cz19mjc7tmkx8.setup(editor);
    $_14lvpb17kjc7tmknm.addToEditor(editor, panel);
    return $_a3b7a5162jc7tmker.get(editor, panel);
  });
  var Theme = function () {
  };
